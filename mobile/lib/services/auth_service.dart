...
class AuthUser {
  ...
  AuthUser({required this.id, required this.name, required this.username, required this.email, this.photo, required this.role, this.saleType = 'SHOP', this.branchId, this.truckId});
  ...
  factory AuthUser.fromJson(Map<String, dynamic> json) => AuthUser(
        ...
        photo: json['photo'],
        role: json['role'],
        saleType: json['saleType'] as String? ?? 'SHOP',
